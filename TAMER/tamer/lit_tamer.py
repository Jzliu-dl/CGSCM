...
from tamer.utils.utils import (
    ExpRateRecorder, Hypothesis, ce_loss, focal_loss_with_ignore, to_bi_tgt_out, to_struct_output)
from tamer.utils.generation_pred import generate_default_label_set, generate_new_label_set, out_hat_to_pred
...
class LitTAMER(pl.LightningModule):
    ...
    def forward(
        ...
        FloatTensor
            [2b, l, vocab_size]
        """
        return self.tamer_model(img, img_mask, text, text_mask, tgt)
    ...
    def training_step(self, batch: Batch, _):
        ...
        if self.current_epoch > 20:
            out_hat ,_ ,_ = self(batch.imgs, batch.mask, pred_paddded,pred_mask, tgt)
        ...
        out_hat, sim, msk_hat = self(batch.imgs, batch.mask, pred_paddded, pred_mask, tgt)
        ...
        return loss + struct_loss + ogl_loss
...
#            return
    ...
    def approximate_joint_search(
        ...
        return self.tamer_model.beam_search(img, mask, text, text_mask,**self.hparams)
