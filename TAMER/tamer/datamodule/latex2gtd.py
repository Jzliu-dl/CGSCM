...
def latex2Tree(latex: list):
    ...
    """
    max_len = 200
    assert len(latex) < max_len, "latex too long"
    if len(latex) == 0:
        return Node("<eol>")
...
if __name__ == "__main__":
    ...
    latex = r"| x ^ { \frac { 1  { n } } - c ^ { \frac { 1  { n } } | = \frac { | x ^ { \frac { 1 } { n } } - c ^ { \frac { 1 } { n } } | | x ^ { \frac { n - 1 } { n }  + x ^ { \frac { n - 2 } { n } } c ^ { \frac { 1 } { n } } + \cdots + x ^ { \frac { 1 } { n } } c ^ { \frac { n - 2 } { n } } | } { | x ^ { \frac { n - 1 } { n } } + x ^ { \frac { n - 2 } { n } } c ^ { \frac { 1 } { n } } + \cdots + x ^ { \frac { 1 } { n } } c ^ { \frac { n - 2 } { n } } + c ^ { \frac { n - 1 } { n } } | }"
    latex_ls = [Symbol(i, t) for i, t in enumerate(latex.split())]
    tree = latex2Tree(latex_ls)
    gtd = node2list(tree)
    print("original gtd:")
